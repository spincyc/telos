...
% Which decision governs the paragraph you are reading. The manuals are
% generated from the same repository as the ADRs, and a reader who disagrees
% with an instruction should be able to find the decision behind it.
