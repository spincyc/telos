...
\begin{center}
\includegraphics[width=\linewidth,height=.31\textheight,keepaspectratio]{lake-country-fishing/chatgpt/cooking/pumpkinseed/plates/cleaning.png}

{\scriptsize\textit{Main: lift the belly wall and open shallowly from vent
toward throat. Inset: scale tail-to-head before whole or skin-on cooking.}}
\end{center}
\begin{enumerate}
...
\begin{center}
\includegraphics[width=\linewidth,height=.37\textheight,keepaspectratio]{lake-country-fishing/chatgpt/cooking/pumpkinseed/plates/fillet-bones.png}

{\scriptsize\textit{Keep the blade against the frame while lifting the fillet.
Inset: feel for the short center pin line; remove it with a narrow V.}}
\end{center}
...
\begin{center}
\includegraphics[width=\linewidth,height=.28\textheight,keepaspectratio]{lake-country-fishing/chatgpt/cooking/pumpkinseed/plates/cooking.png}

{\scriptsize\textit{Left: skillet-cook the scaled whole fish. Right:
crumb-bake matched fillets. Verify \qty{145}{^\circ F} in the thickest flesh.}}
\end{center}
