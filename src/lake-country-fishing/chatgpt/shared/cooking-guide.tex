...
\telosmeta{Lake Country Fishing · ChatGPT}{Cooking \FishName}{From legal fish to boneless meal}{20260726.001}
\begin{document}
...
the thickest portion, away from pan, rack, and bone. Read the lowest stable
temperature rather than the first changing number.
...
\newpage
\section{Batch worksheet · complete after the meal}
\begin{center}
\begin{tikzpicture}[x=1cm,y=1cm]
...
\node[font=\scriptsize,anchor=north west] at (.12,2.2)
  {Sketch pan / rack order; label thickness, probe entry, and early removals};
\end{tikzpicture}
\end{center}

\begin{tabularx}{\linewidth}{@{}p{.20\linewidth}p{.15\linewidth}p{.17\linewidth}p{.16\linewidth}L@{}}
\toprule
\textbf{Piece / position}&\textbf{Thickness}&\textbf{First check}&
\textbf{Final °F}&\textbf{Correction / result}\\
\midrule
&&&&\\[.7em]
&&&&\\[.7em]
&&&&\\
...
Batch start: \rule{22mm}{.4pt}\quad
Thickest / thinnest: \rule{14mm}{.4pt} / \rule{14mm}{.4pt} in\quad
Lowest stable center: \rule{16mm}{.4pt}\,°F

\smallskip
Which piece finished first, and what evidence triggered its removal?
\par\noindent\rule{\linewidth}{.4pt}

\smallskip
Final bone check and split-center result:
\par\noindent\rule{\linewidth}{.4pt}

\smallskip
Leftovers refrigerated at: \rule{24mm}{.4pt}
\end{teloscard}
