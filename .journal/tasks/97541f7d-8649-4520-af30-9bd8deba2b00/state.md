...
updated_at: "2026-07-27T21:57:14Z"
---
...
The ledger now identifies sealed media and immutable releases as the next
factory gate, obsolete agent-state snapshots are removed, and `HANDOFF.md` is
explicitly historical. Local media and accepted private evidence were
preserved.
